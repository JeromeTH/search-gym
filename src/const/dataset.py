...
NCL_METADATA: List[EntryMeta] = [
    ...
    EntryMeta(name="year", type="int", max_length=4),
    EntryMeta(name="category", type="str", max_length=64),
    EntryMeta(name="link", type="str", max_length=512),
    EntryMeta(name="keywords", type="str", max_length=512),
    EntryMeta(name="school_chinese", type="str", max_length=128),
    EntryMeta(name="school_english", type="str", max_length=128),
    EntryMeta(name="dept_chinese", type="str", max_length=128),
    EntryMeta(name="dept_english", type="str", max_length=128),
    EntryMeta(name="authors_chinese", type="str", max_length=256),
    EntryMeta(name="authors_english", type="str", max_length=256),
    EntryMeta(name="advisors_chinese", type="str", max_length=256),
    EntryMeta(name="advisors_english", type="str", max_length=256),
]

# --- Channel fields based on NCLDocument.channels ---
NCL_CHANNELS: List[EntryMeta] = [
    EntryMeta(name="abstract_chinese", type="str", max_length=4096),
    EntryMeta(name="abstract_english", type="str", max_length=4096),
    EntryMeta(name="title_chinese", type="str", max_length=512),
    EntryMeta(name="title_english", type="str", max_length=512),
]
...
LITSEARCH_METADATA: List[EntryMeta] = [
    EntryMeta(name="corpusid", type="int", max_length=16),
    EntryMeta(name="year", type="int", max_length=4),
    EntryMeta(name="venue", type="str", max_length=128),
    EntryMeta(name="authors", type="str", max_length=128),
    EntryMeta(name="doi", type="str", max_length=128),
    EntryMeta(name="arxiv", type="str", max_length=64),
    EntryMeta(name="dblp", type="str", max_length=128),
    EntryMeta(name="pdfurl", type="str", max_length=256),
]

# --- Channel fields based on LitSearchDocument.channels ---
LITSEARCH_CHANNELS: List[EntryMeta] = [
    EntryMeta(name="abstract", type="str", max_length=2048),
    EntryMeta(name="title", type="str", max_length=256),
]
