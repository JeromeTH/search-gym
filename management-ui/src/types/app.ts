...
export type RouterConfig = SimpleRouterConfig;

export const RerankerTypeValues = ["identity", "auto_model"] as const;
export type RerankerType = (typeof RerankerTypeValues)[number];

export interface IdentityRerankerConfig {
  type: "identity";
}

export interface AutoModelRerankerConfig {
  type: "auto_model";
  model_name: string;
}

export type RerankerConfig = IdentityRerankerConfig | AutoModelRerankerConfig;
